...
namespace Binance.Net.UnitTests
{
    ...
    internal class BinanceRestIntegrationTests : RestIntegrationTest<BinanceRestClient>
    {
        ...
        {
            await RunAndCheckResult(client => client.SpotApi.Account.GetAccountInfoAsync(default, default, default), true);
            ...
            await RunAndCheckResult(client => client.SpotApi.Account.GetFundingWalletAsync(default, default, default, default), true);
            ...
            await RunAndCheckResult(client => client.SpotApi.Account.GetTransfersAsync(Enums.UniversalTransferType.FundingToUsdFutures, default, default, default, default, default, default), true);
        ...
        public async Task TestSpotExchangeData()
        {
            ...
            await RunAndCheckResult(client => client.SpotApi.ExchangeData.GetTradeHistoryAsync("ETHUSDT", 1, 1, CancellationToken.None), false);
            await RunAndCheckResult(client => client.SpotApi.ExchangeData.GetAggregatedTradeHistoryAsync("ETHUSDT", null, null, null, 10, CancellationToken.None), false);
            await RunAndCheckResult(client => client.SpotApi.ExchangeData.GetKlinesAsync("ETHUSDT", Enums.KlineInterval.OneHour, DateTime.UtcNow.AddDays(-1), DateTime.UtcNow, 1, CancellationToken.None), false);
        ...
        public async Task TestSpotTrading()
        {
            ...
            await RunAndCheckResult(client => client.SpotApi.Trading.GetOpenAlgoOrdersAsync(default, default), true);
            await RunAndCheckResult(client => client.SpotApi.Trading.GetClosedAlgoOrdersAsync(default, default, default, default, default, default, default, default), true);
        ...
        public async Task TestUsdFuturesExchangeData()
        {
            ...
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetTopLongShortAccountRatioAsync("ETHUSDT", Enums.PeriodInterval.OneDay, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetTopLongShortPositionRatioAsync("ETHUSDT", Enums.PeriodInterval.OneDay, null, null, null, CancellationToken.None), false);
            ...
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetPricesAsync(CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetBookPriceAsync("ETHUSDT", CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetOpenInterestAsync("ETHUSDT", CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetOpenInterestHistoryAsync("ETHUSDT", Enums.PeriodInterval.FifteenMinutes, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetTakerBuySellVolumeRatioAsync("ETHUSDT", Enums.PeriodInterval.OneDay, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetCompositeIndexInfoAsync(null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetPriceAsync("ETHUSDT", CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetContinuousContractKlinesAsync("ETHUSDT", Enums.ContractType.Perpetual, Enums.KlineInterval.OneDay, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetIndexPriceKlinesAsync("ETHUSDT", Enums.KlineInterval.OneDay, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetAssetIndexesAsync(CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetBasisAsync("ETHUSDT", Enums.ContractType.Perpetual, Enums.PeriodInterval.OneDay, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.UsdFuturesApi.ExchangeData.GetIndexPriceConstituentsAsync("ETHUSDT", CancellationToken.None), false);
        }
        ...
        public async Task TestUsdFuturesTrading()
        {
            ...
            await RunAndCheckResult(client => client.UsdFuturesApi.Trading.GetPositionsAsync(default, default, default), true);
        }
        ...
        public async Task TestCoinFuturesAccount()
        {
            ...
            await RunAndCheckResult(client => client.CoinFuturesApi.Account.GetBalancesAsync(default, default), true);
            await RunAndCheckResult(client => client.CoinFuturesApi.Account.GetPositionInformationAsync(default, default, default, default), true);
            await RunAndCheckResult(client => client.CoinFuturesApi.Account.GetUserCommissionRateAsync("ETHUSD_PERP", default, default), true);
        }
        ...
        public async Task TestCoinFuturesExchangeData()
        {
            ...
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetPricesAsync(null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetBasisAsync("ETHUSD", Enums.ContractType.Perpetual, Enums.PeriodInterval.OneDay, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetTakerBuySellVolumeRatioAsync("ETHUSD", Enums.ContractType.Perpetual, Enums.PeriodInterval.OneDay, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetOpenInterestHistoryAsync("ETHUSD", Enums.ContractType.Perpetual, Enums.PeriodInterval.OneDay, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetOpenInterestAsync("ETHUSD_PERP", CancellationToken.None), false);
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetBookPricesAsync(null, null, CancellationToken.None), false);
            ...
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetTopLongShortPositionRatioAsync("ETHUSD", Enums.PeriodInterval.OneDay, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetTopLongShortAccountRatioAsync("ETHUSD", Enums.PeriodInterval.OneDay, null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetFundingInfoAsync(CancellationToken.None), false);
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetFundingRatesAsync("ETHUSD_PERP", null, null, null, CancellationToken.None), false);
            await RunAndCheckResult(client => client.CoinFuturesApi.ExchangeData.GetIndexPriceConstituentsAsync("ETHUSD", CancellationToken.None), false);
        }

        [Test]
        public async Task TestCoinFuturesTrading()
        {
            await RunAndCheckResult(client => client.CoinFuturesApi.Trading.GetOpenOrdersAsync("ETHUSD_PERP", default, default), true);
