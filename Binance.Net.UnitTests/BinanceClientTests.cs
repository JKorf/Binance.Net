...
namespace Binance.Net.UnitTests
{
    ...
    public class BinanceClientTests
    {
        ...
        public void TestConstructorConfiguration()
        {
            ...
            Assert.That(((BinanceRestClientSpotApi)restClient.SpotApi).AuthenticationProvider.Key, Is.EqualTo("123"));
            Assert.That(((BinanceSocketClientSpotApi)socketClient.SpotApi).AuthenticationProvider.Key, Is.EqualTo("456"));
