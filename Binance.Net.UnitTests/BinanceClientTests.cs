...
namespace Binance.Net.UnitTests
{
    ...
    public class BinanceClientTests
    {
        ...
        public async Task EnablingAutoTimestamp_Should_CallServerTime()
        {
            ...
            // assert
            Mock.Get(client.SpotApi.RequestFactory).Verify(f => f.Create(It.IsAny<Version>(), It.IsAny<HttpMethod>(), It.Is<Uri>((uri) => uri.ToString().Contains("/time")), It.IsAny<int>()), Times.Exactly(2));
        }
