...
namespace Binance.Net.Clients.Rest.CoinFutures
{
    ...
    /// </summary>
    public class BinanceClientCoinFuturesMarketAccount: IBinanceClientCoinFuturesMarketAccount
    {
        ...
        internal BinanceClientCoinFuturesMarketAccount(BinanceClientCoinFuturesMarket baseClient)
        {
