...
namespace Binance.Net.Clients.Rest.CoinFutures
{
    ...
    /// </summary>
    public class BinanceClientCoinFuturesMarketTrading : IBinanceClientCoinFuturesMarketTrading
    {
        ...
        internal BinanceClientCoinFuturesMarketTrading(Log log, BinanceClientCoinFuturesMarket baseClient)
        {
            _log = log;
