...
namespace Binance.Net.Clients.Rest.CoinFutures
{
    ...
    /// </summary>
    public class BinanceClientCoinFuturesMarketExchangeData : IBinanceClientCoinFuturesMarketExchangeData
    {
        ...
        private readonly BinanceClientCoinFuturesMarket _baseClient;

        internal BinanceClientCoinFuturesMarketExchangeData(Log log, BinanceClientCoinFuturesMarket baseClient)
        {
            _log = log;
