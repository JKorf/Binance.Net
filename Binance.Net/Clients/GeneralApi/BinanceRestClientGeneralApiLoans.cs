...
namespace Binance.Net.Clients.GeneralApi
{
    ...
    public class BinanceRestClientGeneralApiLoans : IBinanceRestClientGeneralApiLoans
    {
        ...
        public async Task<WebCallResult<IEnumerable<BinanceCryptoLoanIncome>>> GetIncomeHistoryAsync(string asset, LoanIncomeType? type = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<IEnumerable<BinanceCryptoLoanIncome>>(_baseClient.GetUrl("loan/income", "sapi", "1"), HttpMethod.Get, ct, parameters, true, weight: 6000, gate: BinanceRateLimiting.SpotApi_Uid).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceCryptoLoanBorrow>> BorrowAsync(string loanAsset, string collateralAsset, int loanTerm, decimal? loanQuantity = null, decimal? collateralQuantity = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceCryptoLoanBorrow>(_baseClient.GetUrl("loan/borrow", "sapi", "1"), HttpMethod.Post, ct, parameters, true, weight: 36000, gate: BinanceRateLimiting.SpotApi_Uid).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceQueryRecords<BinanceCryptoLoanBorrowRecord>>> GetBorrowHistoryAsync(long? orderId = null, string? loanAsset = null, string? collateralAsset = null, DateTime? startTime = null, DateTime? endTime = null, int? page = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceQueryRecords<BinanceCryptoLoanBorrowRecord>>(_baseClient.GetUrl("loan/borrow/history", "sapi", "1"), HttpMethod.Get, ct, parameters, true, weight: 400, gate: BinanceRateLimiting.SpotApi_Ip).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceQueryRecords<BinanceCryptoLoanOpenBorrowOrder>>> GetOpenBorrowOrdersAsync(long? orderId = null, string? loanAsset = null, string? collateralAsset = null, int? page = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceQueryRecords<BinanceCryptoLoanOpenBorrowOrder>>(_baseClient.GetUrl("loan/ongoing/orders", "sapi", "1"), HttpMethod.Get, ct, parameters, true, weight: 300, gate: BinanceRateLimiting.SpotApi_Ip).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceCryptoLoanRepay>> RepayAsync(long orderId, decimal quantity, bool? repayWithBorrowedAsset = null, bool? collateralReturn = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceCryptoLoanRepay>(_baseClient.GetUrl("loan/repay", "sapi", "1"), HttpMethod.Post, ct, parameters, true, weight: 6000, gate: BinanceRateLimiting.SpotApi_Uid).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceQueryRecords<BinanceCryptoLoanRepayRecord>>> GetRepayHistoryAsync(long? orderId = null, string? loanAsset = null, string? collateralAsset = null, DateTime? startTime = null, DateTime? endTime = null, int? page = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceQueryRecords<BinanceCryptoLoanRepayRecord>>(_baseClient.GetUrl("loan/repay/history", "sapi", "1"), HttpMethod.Get, ct, parameters, true, weight: 400, gate: BinanceRateLimiting.SpotApi_Ip).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceCryptoLoanLtvAdjust>> AdjustLTVAsync(long orderId, decimal quantity, bool addOrRmove, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceCryptoLoanLtvAdjust>(_baseClient.GetUrl("loan/adjust/ltv", "sapi", "1"), HttpMethod.Post, ct, parameters, true, weight: 6000, gate: BinanceRateLimiting.SpotApi_Uid).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceQueryRecords<BinanceCryptoLoanLtvAdjustRecord>>> GetLtvAdjustHistoryAsync(long? orderId = null, string? loanAsset = null, string? collateralAsset = null, DateTime? startTime = null, DateTime? endTime = null, int? page = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceQueryRecords<BinanceCryptoLoanLtvAdjustRecord>>(_baseClient.GetUrl("loan/ltv/adjustment/history", "sapi", "1"), HttpMethod.Get, ct, parameters, true, weight: 400, gate: BinanceRateLimiting.SpotApi_Ip).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceQueryRecords<BinanceCryptoLoanAsset>>> GetLoanableAssetsAsync(string? loanAsset = null, int? vipLevel = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceQueryRecords<BinanceCryptoLoanAsset>>(_baseClient.GetUrl("loan/loanable/data", "sapi", "1"), HttpMethod.Get, ct, parameters, true, weight: 400, gate: BinanceRateLimiting.SpotApi_Ip).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceQueryRecords<BinanceCryptoLoanCollateralAsset>>> GetCollateralAssetsAsync(string? collateralAsset = null, int? vipLevel = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceQueryRecords<BinanceCryptoLoanCollateralAsset>>(_baseClient.GetUrl("loan/collateral/data", "sapi", "1"), HttpMethod.Get, ct, parameters, true, weight: 400, gate: BinanceRateLimiting.SpotApi_Ip).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceCryptoLoanRepayRate>> GetCollateralRepayRateAsync(string loanAsset, string collateralAsset, decimal quantity, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceCryptoLoanRepayRate>(_baseClient.GetUrl("loan/repay/collateral/rate", "sapi", "1"), HttpMethod.Get, ct, parameters, true, weight: 6000, gate: BinanceRateLimiting.SpotApi_Ip).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<WebCallResult<BinanceQueryRecords<BinanceCryptoLoanMarginCallResult>>> CustomizeMarginCallAsync(decimal marginCall, string? orderId = null, string? collateralAsset = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceQueryRecords<BinanceCryptoLoanMarginCallResult>>(_baseClient.GetUrl("loan/customize/margin_call", "sapi", "1"), HttpMethod.Post, ct, parameters, true, weight: 6000, gate: BinanceRateLimiting.SpotApi_Uid).ConfigureAwait(false);
        }
        #endregion
    }
}
