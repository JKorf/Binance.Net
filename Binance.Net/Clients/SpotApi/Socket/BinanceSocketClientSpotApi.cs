...
namespace Binance.Net.Clients.SpotApi
{
    ...
    {
        #region fields
        private readonly BinanceSocketClientSpotSharedApi _sharedApi;
            ...
            base(loggerFactory, BinanceExchange.Metadata.Id,options.Environment.SpotSocketStreamAddress, options, options.SpotOptions)
        {
            ...
            _sharedApi = new BinanceSocketClientSpotSharedApi(this);
        ...
        public IBinanceSocketClientSpotApiShared SharedClient => _sharedApi;
        public IBinanceSocketClientSpotSharedApi SharedApi => _sharedApi;
