...
namespace Binance.Net.Clients.Rest.UsdFutures
{
    ...
    /// </summary>
    public class BinanceClientUsdFuturesMarketAccount: IBinanceClientUsdFuturesMarketAccount
    {
        ...
        internal BinanceClientUsdFuturesMarketAccount(BinanceClientUsdFuturesMarket baseClient)
        {
