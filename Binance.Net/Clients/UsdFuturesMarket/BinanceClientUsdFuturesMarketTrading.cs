...
namespace Binance.Net.Clients.Rest.UsdFutures
{
    ...
    /// </summary>
    public class BinanceClientUsdFuturesMarketTrading: IBinanceClientUsdFuturesMarketTrading
    {
        ...
        internal BinanceClientUsdFuturesMarketTrading(Log log, BinanceClientUsdFuturesMarket baseClient)
        {
            _log = log;
