...
namespace Binance.Net.Clients.Rest.UsdFutures
{
    ...
    /// </summary>
    public class BinanceClientUsdFuturesMarketExchangeData : IBinanceClientUsdFuturesMarketExchangeData
    {
        ...
        private readonly BinanceClientUsdFuturesMarket _baseClient;

        internal BinanceClientUsdFuturesMarketExchangeData(Log log, BinanceClientUsdFuturesMarket baseClient)
        {
            _log = log;
