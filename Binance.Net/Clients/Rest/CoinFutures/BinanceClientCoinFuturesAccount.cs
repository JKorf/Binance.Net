...
namespace Binance.Net.Clients.Rest.CoinFutures
{
    ...
    /// </summary>
    public class BinanceClientCoinFuturesAccount: IBinanceClientCoinFuturesAccount
    {
        ...
        internal BinanceClientCoinFuturesAccount(Log log, BinanceClientCoinFutures baseClient)
        {
            _log = log;
        ...
        public async Task<WebCallResult<BinanceFuturesCoinAccountInfo>> GetAccountInfoAsync(long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await _baseClient.SendRequestInternal<BinanceFuturesCoinAccountInfo>(_baseClient.GetUrl(accountInfoEndpoint, api, "1"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        }
