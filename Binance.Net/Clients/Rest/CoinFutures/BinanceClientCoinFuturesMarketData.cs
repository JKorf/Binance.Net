...
namespace Binance.Net.Clients.Rest.CoinFutures
{
    ...
    /// </summary>
    public class BinanceClientCoinFuturesMarketData : IBinanceClientCoinFuturesMarketData
    {
        ...
        internal BinanceClientCoinFuturesMarketData(Log log, BinanceClientCoinFutures baseClient)
        {
            _log = log;
