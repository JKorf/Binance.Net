...
{
    /// <inheritdoc />
    public class BinanceClientUsdFutures : BinanceBaseClient, IBinanceClientUsdFutures
    {
        #region fields 
        ...
        /// </summary>
        public BinanceClientUsdFutures() : this(BinanceClientUsdFuturesOptions.Default)
        {
        }
        ...
        public BinanceClientUsdFutures(BinanceClientUsdFuturesOptions options) : base("Binance[UsdFutures]", options, options.ApiCredentials == null ? null : new BinanceAuthenticationProvider(options.ApiCredentials))
        {
        ...
        public static void SetDefaultOptions(BinanceClientUsdFuturesOptions options)
        {
            BinanceClientUsdFuturesOptions.Default = options;
        }
