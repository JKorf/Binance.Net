...
namespace Binance.Net.Clients.Rest.UsdFutures
{
    ...
    /// </summary>
    public class BinanceClientUsdFuturesMarketData : IBinanceClientUsdFuturesMarketData
    {
        ...
        internal BinanceClientUsdFuturesMarketData(Log log, BinanceClientUsdFutures baseClient)
        {
            _log = log;
