...
namespace Binance.Net.Clients.Rest.Spot
{
    ...
    /// </summary>
    public class BinanceClientSpotMarketLiquidSwap: IBinanceClientSpotMarketLiquidSwap
    {
        ...
        internal BinanceClientSpotMarketLiquidSwap(BinanceClientSpotMarket baseClient)
        {
