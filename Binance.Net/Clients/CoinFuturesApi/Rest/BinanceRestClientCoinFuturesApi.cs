...
namespace Binance.Net.Clients.CoinFuturesApi
{
    ...
    {
        #region fields 
        private readonly BinanceRestClientCoinFuturesSharedApi _sharedApi;
            ...
            : base(loggerFactory, BinanceExchange.Metadata.Id, httpClient, options.Environment.CoinFuturesRestAddress!, options, options.CoinFuturesOptions)
        {
            ...
            _sharedApi = new BinanceRestClientCoinFuturesSharedApi(this);
        ...
        public IBinanceRestClientCoinFuturesApiShared SharedClient => _sharedApi;
        public IBinanceRestClientCoinFuturesSharedApi SharedApi => _sharedApi;
