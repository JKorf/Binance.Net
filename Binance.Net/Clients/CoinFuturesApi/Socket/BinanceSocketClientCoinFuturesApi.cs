...
namespace Binance.Net.Clients.CoinFuturesApi
{
    ...
    {
        #region fields
        private readonly BinanceSocketClientCoinFuturesSharedApi _sharedApi;
            ...
            base(loggerFactory, BinanceExchange.Metadata.Id, options.Environment.CoinFuturesSocketAddress!, options, options.CoinFuturesOptions)
        {
            ...
            _sharedApi = new BinanceSocketClientCoinFuturesSharedApi(this);
        ...
        public IBinanceSocketClientCoinFuturesApiShared SharedClient => _sharedApi;
        public IBinanceSocketClientCoinFuturesSharedApi SharedApi => _sharedApi;
