...
namespace Binance.Net.Clients.CoinFuturesApi
{
    internal class BinanceSocketClientCoinFuturesApiTrading : IBinanceSocketClientCoinFuturesApiTrading
    {
        ...
        /// <inheritdoc />
        public async Task<CallResult<BinanceResponse<BinanceFuturesOrder>>> EditOrderAsync(string symbol, OrderSide side, decimal quantity, decimal price, PriceMatch? priceMatch = null, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default)
        {
