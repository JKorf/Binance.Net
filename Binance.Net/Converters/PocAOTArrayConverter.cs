...
//    class PocArrayConverter<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicProperties)]T> : JsonConverter<T> where T : new()
//# else
//    class PocArrayConverter<T> : JsonConverter<T> where T : new()
//#endif
//    {
