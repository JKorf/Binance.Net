...
namespace Binance.Net.Interfaces.Clients.UsdFuturesApi
{
    ...
    public interface IBinanceSocketClientUsdFuturesApiTrading
    {
        ...
        Task<QueryResult<BinanceResponse<BinanceUsdFuturesOrder>>> PlaceOrderAsync(string symbol,
        ...
        Task<QueryResult<BinanceResponse<BinanceUsdFuturesOrder>>> CancelOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<QueryResult<BinanceResponse<BinanceUsdFuturesOrder>>> GetOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<QueryResult<BinanceResponse<BinancePositionV3[]>>> GetPositionsAsync(string? symbol = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<QueryResult<BinanceResponse<BinanceFuturesConditionalOrder>>> PlaceConditionalOrderAsync(
            string symbol,
            Enums.OrderSide side,
        ...
        Task<QueryResult<BinanceResponse<BinanceFuturesConditionalOrder>>> CancelConditionalOrderAsync(
            long? orderId = null,
            string? clientOrderId = null,
