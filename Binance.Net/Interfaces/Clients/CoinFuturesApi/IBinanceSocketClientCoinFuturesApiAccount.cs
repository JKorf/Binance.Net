...
namespace Binance.Net.Interfaces.Clients.CoinFuturesApi
{
    ...
    public interface IBinanceSocketClientCoinFuturesApiAccount
    {
        ...
        Task<WebSocketResult<BinanceResponse<BinanceCoinFuturesAccountBalance[]>>> GetBalancesAsync(long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebSocketResult<BinanceResponse<BinanceFuturesCoinAccountInfo>>> GetAccountInfoAsync(long? receiveWindow = null, CancellationToken ct = default);
