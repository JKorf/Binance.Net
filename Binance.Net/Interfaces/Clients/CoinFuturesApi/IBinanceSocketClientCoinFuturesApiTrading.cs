...
namespace Binance.Net.Interfaces.Clients.CoinFuturesApi
{
    ...
    /// </summary>
    public interface IBinanceSocketClientCoinFuturesApiTrading
    {
        /// <summary>
        /// Places a new order
        /// <para>
        ...
        Task<WebSocketResult<BinanceResponse<BinanceFuturesOrder>>> PlaceOrderAsync(string symbol,
        ...
        Task<WebSocketResult<BinanceResponse<BinanceFuturesOrder>>> EditOrderAsync(string symbol, OrderSide side, decimal quantity, decimal? price = null, PriceMatch? priceMatch = null, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebSocketResult<BinanceResponse<BinanceFuturesOrder>>> CancelOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebSocketResult<BinanceResponse<BinanceFuturesOrder>>> GetOrderAsync(string symbol, long? orderId = null, string? origClientOrderId = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebSocketResult<BinanceResponse<BinancePositionDetailsCoin[]>>> GetPositionsAsync(string? symbol = null, long? receiveWindow = null, CancellationToken ct = default);
