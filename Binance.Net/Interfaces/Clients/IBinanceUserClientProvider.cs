...
namespace Binance.Net.Interfaces.Clients
{
    ...
    public interface IBinanceUserClientProvider : IExchangeService
    {
        ...
        void InitializeUserClient(string userIdentifier, BinanceCredentials credentials, BinanceEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IBinanceRestClient GetRestClient(string userIdentifier, BinanceCredentials? credentials = null, BinanceEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IBinanceSocketClient GetSocketClient(string userIdentifier, BinanceCredentials? credentials = null, BinanceEnvironment? environment = null);
    }
}