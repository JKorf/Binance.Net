...
namespace Binance.Net.Interfaces.Clients.SpotApi
{
    ...
    public interface IBinanceRestClientSpotApiAccount
    {
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<BinanceWalletBalance[]>> GetWalletBalancesAsync(int? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="receiveWindow">The receive window for which this request is active. When the request takes longer than this to complete the server will reject the request</param>
        /// <param name="ct">Cancellation token</param>
        Task<WebCallResult<BinanceBlvtUserLimit[]>> GetLeveragedTokensUserLimitAsync(string? tokenName = null, long? receiveWindow = null, CancellationToken ct = default);
