...
namespace Binance.Net.Interfaces.SubClients.Futures
{
    ...
    public interface IBinanceClientFuturesCoinOrder: IBinanceClientFuturesOrders
    {
        ...
        WebCallResult<IEnumerable<BinanceFuturesCoinTrade>> GetMyTrades(string? symbol = null, string? pair = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, long? fromId = null, long? receiveWindow = null, CancellationToken ct = default);
