...
namespace Binance.Net.SubClients.Futures.Coin
{
    ...
    public class BinanceClientFuturesCoinMarket: BinanceClientFuturesMarket, IBinanceClientFuturesCoinMarket
    {
        ...
        public override WebCallResult<IEnumerable<BinanceRecentTrade>> GetSymbolTrades(string symbol, int? limit = null,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of recent trades</returns>
        public override async Task<WebCallResult<IEnumerable<BinanceRecentTrade>>> GetSymbolTradesAsync(string symbol, int? limit = null, CancellationToken ct = default)
        {
            ...
            return new WebCallResult<IEnumerable<BinanceRecentTrade>>(result.ResponseStatusCode, result.ResponseHeaders,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of recent trades</returns>
        public override WebCallResult<IEnumerable<BinanceRecentTrade>> GetHistoricalSymbolTrades(string symbol,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of recent trades</returns>
        public override async Task<WebCallResult<IEnumerable<BinanceRecentTrade>>> GetHistoricalSymbolTradesAsync(string symbol, int? limit = null, long? fromId = null,
            CancellationToken ct = default)
        {
            limit?.ValidateIntBetween(nameof(limit), 1, 1000);
            var parameters = new Dictionary<string, object> { { "symbol", symbol } };
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>The candlestick data for the provided symbol</returns>
        public async Task<WebCallResult<IEnumerable<BinanceKline>>> GetContinuousContractKlinesAsync(string pair, ContractType contractType, KlineInterval interval, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, CancellationToken ct = default)
        {
            limit?.ValidateIntBetween(nameof(limit), 1, 1000);
            var parameters = new Dictionary<string, object> {
                { "pair", pair },
            ...
            return await BaseClient.SendRequestInternal<IEnumerable<BinanceKline>>(FuturesClient.GetUrl(continuousContractKlineEndpoint, Api, publicVersion), HttpMethod.Get, ct, parameters).ConfigureAwait(false);
        }
        ...
        public WebCallResult<IEnumerable<BinanceFuturesCoin24HPrice>> Get24HPrices(string? symbol = null, string? pair = null, CancellationToken ct = default) => Get24HPricesAsync(symbol, pair, ct).Result;
