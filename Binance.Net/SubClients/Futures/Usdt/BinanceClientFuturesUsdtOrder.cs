...
namespace Binance.Net.SubClients.Futures.Usdt
{
    ...
    public class BinanceClientFuturesUsdtOrder : BinanceClientFuturesOrder, IBinanceClientFuturesUsdtOrder
    {
        ...
        public WebCallResult<IEnumerable<BinanceFuturesUsdtTrade>> GetMyTrades(string symbol, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, long? fromId = null, long? receiveWindow = null, CancellationToken ct = default) => GetMyTradesAsync(symbol, startTime, endTime, limit, fromId, receiveWindow, ct).Result;
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of trades</returns>
        public async Task<WebCallResult<IEnumerable<BinanceFuturesUsdtTrade>>> GetMyTradesAsync(string symbol, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, long? fromId = null, long? receiveWindow = null, CancellationToken ct = default)
        {
