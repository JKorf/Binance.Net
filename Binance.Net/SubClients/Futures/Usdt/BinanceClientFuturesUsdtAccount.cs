...
namespace Binance.Net.SubClients.Futures.Usdt
{
    ...
    public class BinanceClientFuturesUsdtAccount : BinanceClientFuturesAccount, IBinanceClientFuturesUsdtAccount
    {
        ...
        public async Task<WebCallResult<BinanceFuturesAccountUserCommissionRate>> GetUserCommissionRateAsync(string symbol, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            return await BaseClient.SendRequestInternal<BinanceFuturesAccountUserCommissionRate>(FuturesClient.GetUrl(futuresAccountUserCommissionRateEndpoint, Api, "1"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        }
